 ...
 */
final class Version20240726131650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, nom_entreprise VARCHAR(255) NOT NULL, ville_entreprise VARCHAR(255) NOT NULL, departement_entreprise VARCHAR(255) NOT NULL, nom_consultation VARCHAR(255) NOT NULL, annee_creation_consultation VARCHAR(255) NOT NULL, id_consultation VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE projet (id INT AUTO_INCREMENT NOT NULL, nom_site VARCHAR(255) NOT NULL, ville_site VARCHAR(255) NOT NULL, nom_projet VARCHAR(255) NOT NULL, annee_creation_projet VARCHAR(255) NOT NULL, id_projet VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
